...
document.addEventListener('DOMContentLoaded', () => {
 ...
 if (shareBtn) {
        shareBtn.addEventListener('click', () => {
            ...
            const botUsername = 'slim_ru_bot'; 
            
            const shareText = `Привет!👋 Я тут нашла гениальную штуку. Короткий тест, который анализирует твой день (сон, активность, стресс) и говорит, какие продукты дадут тебе максимум энергии, а какие лучше убрать.
Мне он подсказал пару неочевидных вещей, после которых я стала чувствовать себя гораздо бодрее по утрам. Подумала, тебе тоже может быть полезно. Наконец-то что-то простое и по делу, без сложных диет. Очень советую!`;

            // Формируем специальную ссылку для шаринга
            const shareUrl = `https://t.me/share/url?url=${encodeURIComponent(`https://t.me/${botUsername}`)}&text=${encodeURIComponent(shareText)}`;
            
            // Используем новый, более надежный метод для открытия TG-ссылок

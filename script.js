...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (shareBtn) {
        shareBtn.addEventListener('click', () => {
            ...
            const shareText = `Привет! 👋 Прошла тут крутой тест, который анализирует образ жизни и дает персональные рекомендации по питанию. Очень интересно, попробуй тоже!`;
            ...
            // Используем метод Telegram для открытия окна "Поделиться"
